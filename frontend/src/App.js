...
function App() {
  ...
  const { totalDetections, classStats } = useDetectionStats(
    currentLineHistory,
    classMap,
  );
  ...
  const railLine = HAT_CONFIG[selectedLine].stations.map((st) => [
    st.lat,
    st.lng,
  ]);
      ...
      <div className="flex flex-col items-center justify-center mb-6 relative">
        ...
        <div className="flex items-center justify-center gap-3 text-4xl font-heading font-bold text-primary dark:text-white mb-4">
          <svg
            ...
            className="w-9 h-9 text-indigo-600 dark:text-primary"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="lg:col-span-2 space-y-6">
          <MapComponent
            ...
            selectedClassId={
              selectedClass
                ? Number(
                    Object.keys(classMap).find(
                      (k) => classMap[k] === selectedClass,
                    ),
                  )
                : null
            }
            ...
            <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-700 dark:text-gray-300">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Koordinat: {currentLineData.gps.lat},{" "}
                    {currentLineData.gps.lng}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2 col-span-2">
                  ...
                  <span>
                    Zaman:{" "}
                    {new Date(currentLineData.timestamp).toLocaleString()}
                  </span>
                </div>
              </div>
                  ...
                  .map((r, i) => {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          borderColor: classColors[r.class_id] || "#999",
                        }}
                      >
                        <div>
                        ...
                        {severity && (
                          <span
                            className={`flex items-center gap-1 px-2 py-1 text-xs rounded ${severity.color}`}
                          >
        ...
        {currentLineHistory.length === 0 && (
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 text-center text-gray-500 dark:text-gray-300 flex flex-col items-center justify-center gap-3">
            ...
            <p className="italic text-sm">
              Bu hatta henüz tespit edilen bir kusur bulunmamaktadır.
            </p>
          </div>
        )}
